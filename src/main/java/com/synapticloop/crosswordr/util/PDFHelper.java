...
import com.synapticloop.crosswordr.gui.MainApplication;
...
public class PDFHelper {
	 ...
	 * generated)
	 */
	public static String convertToPDF(File xmlFile, File outputDirectory, Puzzle puzzle, Integer number) {
		...
		String pdfFile =  outputDirectory + File.separator + puzzle.getFileName() + puzzle.getDate() + ".pdf";
		...
		try {
			...
			InputStream resourceAsStream = MainApplication.class.getResourceAsStream("/" + puzzle.getXsl());
	 ...
	 * @throws IOException
	 */
	public static void mergeFiles(File outputDirectory, List<String> generatedFiles, String optionRangeStart, String optionRangeEnd) throws IOException {
		// now merge the files
		if(generatedFiles.size() != 0) {
			PDFMergerUtility pdfMergerUtility= new PDFMergerUtility();

			StringBuffer destinationPdf = new StringBuffer(512);
			destinationPdf.append(outputDirectory + File.separator);
